                ...
                <div className={styles.container}>
                  <div className={`${styles.formContainer} ${styles.signInContainer}`}>
                    <form className={styles.form} >
                      ...
                      {props.isLogin?<button className={styles.button}>Sign In</button> : <button onClick={props.onClickSignUp} className={styles.button}>Sign Up</button>}
                  ...
                  <div className={styles.overlayContainer}>
                    <div className={styles.overlay}>
                      <div className={`${styles.overlayPanel} ${styles.overlayRight}`}>
                        ...
                        {props.isLogin && <button onClick={props.onClickLoginState} className={styles.buttonWhite} id="signUp">Sign Up</button>}                       
                      </div>
                    </div>
                  </div>
                </div>
